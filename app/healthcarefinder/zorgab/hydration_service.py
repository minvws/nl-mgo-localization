...
class HydrationService:
    def __init__(self, addressing_service: AddressingService):
    ...
    def _get_organization_identifier(
        self, fhir_org: FhirOrganization
    ) -> Tuple[ZalSearchResponseEntry | None, Identification]:
        identifier_type = None
        identifier_value = None
        data_service_entry = None

        if fhir_org.identifier is None:
            return data_service_entry, Identification(
                identification_type=identifier_type, identification_value=identifier_value
            )
    ...
    def _get_organization_addresses(self, fhir_org: FhirOrganization, load_org: Organization) -> None:
        ...
        for addr_entry in fhir_org.address:
            ...
            lines = []
            if fhir_address.line:
                for line in fhir_address.line:
